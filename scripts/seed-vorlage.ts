...
async function main() {
  const html = fs.readFileSync(path.join(__dirname, "../public/email-vorlage.html"), "utf-8");
  ...
  const vorlage = await (prisma as never as {
    ...
    data: {
      ...
      beschreibung: "Weiße E-Mail mit Logo, Freitext-Bereichen, Highlight-Box und CTA-Button",
