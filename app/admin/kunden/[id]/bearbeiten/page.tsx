...
export default async function KundeBearbeitenPage({
  ...
  const initialDaten: Partial<KundenprofilFormDaten> = {
    ...
    linkInstagram: kunde.linkInstagram ?? "",
    linkFacebook: kunde.linkFacebook ?? "",
    linkTikTok: kunde.linkTikTok ?? "",
    linkYouTube: kunde.linkYouTube ?? "",
    ...
    limitReel: kunde.limitReel?.toString() ?? "",
    limitStory: kunde.limitStory?.toString() ?? "",
    limitBild: kunde.limitBild?.toString() ?? "",
    limitKarussell: kunde.limitKarussell?.toString() ?? "",
