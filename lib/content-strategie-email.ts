export function contentStrategieEmailHtml({
  name,
  unternehmensname,
  formularLink,
}: {
...
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;line-height:1px;color:#f3f1ed;">Bitte füllen Sie das Content-Strategie-Formular für Ihre Zusammenarbeit mit JS Media aus.</div>
...
<p style="margin:0;font-family:'EB Garamond',Georgia,'Times New Roman',serif;font-weight:500;font-size:32px;line-height:1.2;color:#1a1818;letter-spacing:-0.01em;text-align:center;">Ihre Content-Strategie<br/><em style="font-style:italic;font-weight:400;">für ${unternehmensname}.</em></p>
</td></tr>
...
Herzlichen Glückwunsch — Ihre Zusammenarbeit mit JS Media hat begonnen. Um Ihre Content-Strategie maßgeschneidert aufzubauen, bitten wir Sie, das folgende Formular auszufüllen.
</p>
</td></tr>
...
<p style="margin:0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:10px;font-weight:600;letter-spacing:0.18em;text-transform:uppercase;color:#8a8580;line-height:1;">Was Sie erwartet</p>
</td></tr>
<tr><td style="padding:18px 20px;">
<p style="margin:0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:14px;line-height:1.8;color:#4a4540;">
Zielgruppe &amp; Positionierung<br/>
Kernwerte &amp; Alleinstellungsmerkmale<br/>
Content-Themen &amp; Stil<br/>
Drehtage &amp; Logistik<br/>
Freigabe-Prozesse &amp; Besonderheiten
</p>
<p style="margin:12px 0 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:12px;color:#8a8580;line-height:1.6;">Das Formular dauert ca. 10–15 Minuten.</p>
</td></tr>
</table>
</td></tr>
...
<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${formularLink}" style="height:46px;v-text-anchor:middle;width:200px;" arcsize="3%" stroke="f" fillcolor="#c8863c"><w:anchorlock/><center style="color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;">Zum Formular</center></v:roundrect><![endif]-->
<!--[if !mso]><!-->
<a href="${formularLink}" style="display:inline-block;padding:13px 28px;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:#ffffff;text-decoration:none;background:#c8863c;border-radius:4px;">Zum Formular &nbsp;→</a>
<!--<![endif]-->
</td></tr>
