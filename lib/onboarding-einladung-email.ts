export function onboardingEinladungEmailHtml({
  name,
  formularLink,
  passwort,
}: {
...
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;line-height:1px;color:#f3f1ed;">Herzlich willkommen bei JS Media – starten Sie jetzt Ihr Onboarding.</div>
...
<p style="margin:0;font-family:'EB Garamond',Georgia,'Times New Roman',serif;font-weight:500;font-size:32px;line-height:1.2;color:#1a1818;letter-spacing:-0.01em;text-align:center;">Herzlich willkommen<br/><em style="font-style:italic;font-weight:400;">bei JS Media.</em></p>
</td></tr>
...
Schön, dass Sie dabei sind. Um Ihre Zusammenarbeit mit JS Media zu starten, bitten wir Sie, unser kurzes Onboarding-Formular auszufüllen — das dauert nur wenige Minuten.
</p>
</td></tr>
...
<p style="margin:0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:10px;font-weight:600;letter-spacing:0.18em;text-transform:uppercase;color:#8a8580;line-height:1;">Zugang zum Formular</p>
</td></tr>
...
<td style="padding:5px 0;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:15px;color:#1a1818;font-weight:600;letter-spacing:0.16em;">${passwort}</td>
</tr>
</table>
</td></tr>
</table>
...
<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${formularLink}" style="height:46px;v-text-anchor:middle;width:260px;" arcsize="3%" stroke="f" fillcolor="#c8863c"><w:anchorlock/><center style="color:#fff;font-family:Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;">Zum Onboarding-Formular</center></v:roundrect><![endif]-->
<!--[if !mso]><!-->
<a href="${formularLink}" style="display:inline-block;padding:13px 28px;font-family:'Inter',Helvetica,Arial,sans-serif;font-size:12px;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:#ffffff;text-decoration:none;background:#c8863c;border-radius:4px;">Zum Onboarding-Formular &nbsp;→</a>
<!--<![endif]-->
</td></tr>
